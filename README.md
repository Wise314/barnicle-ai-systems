...
Each patent has documented scientific discoveries from real-data validation. Findings, evidence, and methodology are documented in each invention repository.
...
| #5 Thermodynamic Stability Prediction | [thermodynamic-stability-prediction](https://github.com/Wise314/-thermodynamic-stability-prediction) | 7 | [Zenodo DOI](https://doi.org/10.5281/zenodo.20112188) |
...
| Cross-Domain Empirical Evidence for Φ = I·ρ − α·S as an Indicator of Operational Regime (v2) | [thermodynamic-stability-prediction](https://github.com/Wise314/-thermodynamic-stability-prediction) | 8 substrate families with regime-separation evidence (mechanical bearings, aerospace turbofans, electrical grids, geophysical strainmeter and foreshock catalog, quantum qubits, computational neural-network architectures), scope-boundary evidence on biological cardiac (arrhythmia AUC 0.9148, AFib AUC 0.5556), observational structural-role evidence on large language models, preregistered forward test on Bearing2_1 with end-of-life Phi -0.342 satisfying preregistered criterion under git-documented commitment chain, parameters α=0.1 and Φ_c=0.25 fixed in production code 2025-10-21 and reused unchanged across portfolio | [10.5281/zenodo.20112188](https://doi.org/10.5281/zenodo.20112188) |
...
| Training-Free Behavioral Drift Detection in Large Language Models Using Output-Embedding Stability Monitoring | [llm-phi-stability](https://github.com/Wise314/llm-phi-stability) | 8 tests on TinyLlama 1.1B-Chat plus scale-validation on Phi-2 (2.7B), 0.282 quality drift on temperature shift, 0.072 safety-regime drift accompanied by refusal rate drop from 14% to 3%, 0.254 fine-tuning drift between base and instruction-tuned checkpoints, 0.207 adversarial injection drift with matched sampling seeds, -0.97 correlation between Phi and temperature across 8 temperature points | [10.5281/zenodo.20098298](https://doi.org/10.5281/zenodo.20098298) |
| False Coherence: A Thermodynamic Failure Regime in Chain-of-Thought Reasoning | [cot-phi-stability](https://github.com/Wise314/cot-phi-stability) | GSM8K baseline 10/10 stable chains mean Phi 0.520, PRM800K matched pairs revealed two failure regimes (false coherence 7 of 10 with mean delta -0.142, destabilized drift 3 of 10 with mean delta +0.283), three Phi-based self-consistency selectors all underperformed raw majority voting (40 to 50 percent vs 70 percent baseline), cross-domain measurement operational across math factual quantitative and science reasoning above Phi_c = 0.25 with same fixed-form formula, RAG grounding directional evidence (response delta 0.079, sentence delta 0.056), agentic trajectory honest null result on matched within-instance cohort | [10.5281/zenodo.20110938](https://doi.org/10.5281/zenodo.20110938) |
...
**Papers Published:** 17 on Zenodo (latest: Patent #5 Cross-Domain Empirical Evidence v2, May 10, 2026; concept DOI 10.5281/zenodo.18523291)
